...
const COMPLEJOS_DATA: SeedComplejo[] = [
  {
    ...
    ubicacion: 'a 20 cuadras del centro, a 2 cuadras de la playa (bajada La Rinconada, acceso norte)',
  ...
  },
  {
    ...
    ubicacion: 'a 6 cuadras del centro, a 2-3 cuadras de la playa (bajada Los Acantilados)',
    tipo: 'Monoambiente',
    superficie: '35-40 m2',
    capacidad: 3,
    cantidadUnidades: 1,
  ...
  },
  {
    ...
    direccion: 'Golfo San Jorge 560, Las Grutas',
    ubicacion: 'a 6 cuadras del centro, a 2 cuadras de la playa (bajada Los Acantilados)',
    tipo: 'Departamento 2 ambientes',
    superficie: '45-50 m2',
    capacidad: 4,
    cantidadUnidades: 1,
  ...
  },
  {
    ...
    direccion: 'Nahuel Huapi 75, Las Grutas',
    ubicacion: 'a 2 cuadras del centro y de la playa (Primeras Bajadas)',
    tipo: 'Departamento 2 ambientes',
    superficie: '50 m2',
    capacidad: 4,
    cantidadUnidades: 5,
